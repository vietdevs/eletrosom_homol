 ...
 *  @copyright 2012-2019 eMagicOne
 *
 */
define('BRIDGE_VERSION', '7.74');


// PLEASE CHANGE IMMEDIATELY ! It is security threat to leave these values as is !
$username = 'Thiago';
$password = 'qcZFjoH3mhai';
 ...
 *      Example: define('DISABLE_SQL_MODES', true);
...
function getCartType() {
    ...
    if (file_exists(getcwd() . '/app/etc/env.php')
        || file_exists(getcwd() . '/../app/etc/env.php')
    ) {
        ...
        && (file_exists('system/startup.php')
...
class cMySQLBackUp {
    ...
    var $sBackUpFileExt = 'sql';                            // file extension to make back up
    ...
    function _get_tables() {
        ...
        $result = @$this->rLink->query('SHOW FULL TABLES FROM `' . $this->sDBName

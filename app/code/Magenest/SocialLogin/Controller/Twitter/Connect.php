...
class Connect extends \Magento\Framework\App\Action\Action
{
    ...
    protected function connect()
    {
        ...
        $userInfo = array_merge((array)($userInfo = $client->api('/account/verify_credentials.json', $getParams, 'GET', ['skip_status' => true])), ['email' => sprintf('%s@twitter-user.com', strtolower($userInfo['screen_name']))]);

...
class Client
{
    ...
    protected function fetchAccessToken($getParams)
    {
        ...
        if (!($token = $this->client->getAccessToken($params, $this->serializer->unserialize($requestToken)))) {
    ...
    public function fetchRequestToken()
    {
        ...
        $this->_customerSession->setTwitterRequestToken($this->serializer->serialize($requestToken));

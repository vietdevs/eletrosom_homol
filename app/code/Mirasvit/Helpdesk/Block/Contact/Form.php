 ...
 */
class Form extends \Magento\Contact\Block\ContactForm
{
    /**
    ...
    /**
     * @return \Mirasvit\Helpdesk\Block\Contact\Form
     */
    public function getKbBlock()
    {
        return $this->_layout->createBlock('Mirasvit\Helpdesk\Block\Contact\Form')

...
class MassDelete extends \Mirasvit\Helpdesk\Controller\Adminhtml\MassDelete
{
     ...
     * @param \Mirasvit\Helpdesk\Model\ResourceModel\Status $statusResource
     * @param \Mirasvit\Helpdesk\Model\ResourceModel\Status\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        parent::__construct($filter, $context, $permission, $statusResource, $collectionFactory);
    }
}

...
class RolesOptionsProvider implements \Magento\Framework\Data\OptionSourceInterface
{
    /**
    ...
    /**
     * RolesOptionsProvider constructor.
    ...
    {
        return $this->helpdeskHtml->toAdminRoleOptionArray(__('All Roles'));
    }
}

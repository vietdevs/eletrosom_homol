...
/**
 * Command for checking status for helpdesk job
 */
class HelpdeskIsLockedCommand extends Command
{
    /**
    ...
    {
        $this->setName('mirasvit:helpdesk:is-locked')
            ->setDescription('Show is helpdesk job locked'); //test
        parent::configure();
    }

...
class Gateway extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
    ...
    {
        $this->_init('mst_helpdesk_gateway', 'gateway_id');
    }
    ...
    {
        /** @var  \Mirasvit\Helpdesk\Model\Gateway $object */
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if (!$object->getId()) {
            ...
            $object->setFetchedAt((new \DateTime())->format(\Magento\Framework\Stdlib\DateTime::DATETIME_PHP_FORMAT));
        }

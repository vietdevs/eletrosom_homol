...
namespace Mirasvit\Helpdesk\Model\ResourceModel\Department\Grid;
...
class Collection extends DepartmentCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        $mainTable = DepartmentInterface::TABLE_NAME,
        $eventPrefix = 'helpdesk_department_grid_collection',
        $eventObject = 'department_grid_collection',
        $resourceModel = 'Mirasvit\Helpdesk\Model\ResourceModel\Department',

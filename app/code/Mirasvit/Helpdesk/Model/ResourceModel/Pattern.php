...
class Pattern extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
    ...
    {
        $this->_init('mst_helpdesk_pattern', 'pattern_id');
    }
    ...
    {
        /** @var  \Mirasvit\Helpdesk\Model\Pattern $object */

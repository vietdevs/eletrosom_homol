...
class Feed extends AbstractHelper
{
    ...
    const XPATH_FEED_URL = 'magmodules_googleshopping/feeds/url';
    const XPATH_FEED_RESULT = 'magmodules_googleshopping/feeds/results';
    const XPATH_FEED_FILENAME = 'magmodules_googleshopping/generate/filename';
    ...
    public function validateAndMove($config, $type)
    {
        ...
        if (empty($validationErrrors)) {
            ...
            throw new ValidationException(__('Unable to genrate feed due to validation errors, please check var/googleshopping/validation.log'));
        }
    }
    ...
    public function getFeedSummary($timeStart, $count, $limit)
    {
        ...
        $summary['date'] = $this->timezone->formatDateTime(null, 1);
        return $summary;
    }

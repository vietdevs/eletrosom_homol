...
use Magmodules\GoogleShopping\Service\Product\InventoryData;
use Magmodules\GoogleShopping\Service\Product\PriceData;
...
class Product extends AbstractHelper
{
    ...
    public function getPriceCollection($config, $product)
    {
        ...
        return [
            ...
            $priceFields['sales_price']      => $priceData['sales_price'],
            $priceFields['sales_date_range'] => $priceData['sales_date_range'],
        ];
    }

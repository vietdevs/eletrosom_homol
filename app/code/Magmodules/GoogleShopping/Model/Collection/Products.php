...
namespace Magmodules\GoogleShopping\Model\Collection;
 ...
 * Class Products
 *
 * @package Magmodules\GoogleShopping\Model\Collection
 */
class Products
{
    ...
    public function addFilters($filters, $collection, $type = 'simple')
    {
        ...
        $attributeModel = $this->eavConfig->getAttribute('catalog_product', 'googleshopping_exclude');
        if ($attributeModel->getId()) {
            $filters['advanced'][] = [
                'attribute'    => 'googleshopping_exclude',
                'condition'    => 'neq',
                'value'        => 1,

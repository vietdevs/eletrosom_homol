<?php
namespace MestreMage\AutoCompleteZipCode\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $section = ($section) ? $section : 'autocompletezipcode';
    ...
    {
        $group = "mestremage_address_lines/mestremage_address_line{$lineNumber}";
